...
config_file = "/home/aks19/ece411/mp_ooo_tristate/fa25_ece411_TriState/sram/output/mp_cache_data_array/mp_cache_data_array.py"
...
openram_temp = "/tmp/openram_aks19_3874799_temp/"
output_datasheet_info = True
output_extended_config = True
output_name = "mp_cache_data_array"
output_path = "/home/aks19/ece411/mp_ooo_tristate/fa25_ece411_TriState/sram/output/mp_cache_data_array/"
overridden = {'__name__': True, '__doc__': True, '__package__': True, '__loader__': True, '__spec__': True, '__file__': True, '__cached__': True, '__builtins__': True, 'tech_name': True, 'num_rw_ports': True, 'num_r_ports': True, 'num_w_ports': True, 'word_size': True, 'write_size': True, 'num_words': True, 'sim_random_init': True, 'nominal_corner_only': True, 'process_corners': True, 'supply_voltages': True, 'temperatures': True, 'netlist_only': True, 'route_supplies': True, 'check_lvsdrc': True, 'perimeter_pins': True, 'load_scales': True, 'slew_scales': True, 'output_name': True, 'output_path': True, 'print_banner': True, 'num_threads': True, 'output_extended_config': True}
